...
export const exclusions: Array<string> = [
  ...
  // Syncs
  "/api/Commenting/_getCommentForSync",
  "/api/File/_getFileByIdForSync",
  "/api/PasswordAuthentication/_getUserByUsernameForSync",
  "/api/Posting/_getPostByIdForSync",
];
