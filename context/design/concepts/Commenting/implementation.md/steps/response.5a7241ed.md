---
timestamp: 'Sun Oct 12 2025 02:02:52 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251012_020252.fbd18442.md]]'
content_id: 5a7241edb974cbada8815bbff30a646a595f584bbaa03ba528f45365a95de9cf
---

# response:

```typescript
// file: src/Commenting/CommentingConcept.ts
...
export default class CommentingConcept {
  ...
  async _getCommentsForPost(
    ...
    const foundComments = await this.comments.find({ post }).toArray();
  ...
  async _getCommentsByAuthor(
    ...
    const foundComments = await this.comments.find({ author }).toArray();
    return { comments: foundComments };
  }
}
```
